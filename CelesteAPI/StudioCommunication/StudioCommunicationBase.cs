...
public class StudioCommunicationBase {
    ...
    protected StudioCommunicationBase(string target = "Celeste") {
        if (PlatformUtils.Wine || PlatformUtils.NonWindows) {
            ...
            sharedMemory = MemoryMappedFile.CreateFromFile(fs, null, fs.Length, MemoryMappedFileAccess.ReadWrite, HandleInheritability.None,
                true);
        } else {
